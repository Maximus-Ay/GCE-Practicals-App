...
class AlBiologyPage extends StatefulWidget {
  const AlBiologyPage({super.key});

  @override
  State<AlBiologyPage> createState() => _AlBiologyPageState();
}

class _AlBiologyPageState extends State<AlBiologyPage> {
  static const List<Color> _gradient = [Color(0xFF81C784), Color(0xFF388E3C)];
  static const IconData _icon = Icons.eco_rounded;
  static const String _title = 'AL Biology';

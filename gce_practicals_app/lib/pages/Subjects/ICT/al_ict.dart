...
class AlIctPage extends StatefulWidget {
  const AlIctPage({super.key});

  @override
  State<AlIctPage> createState() => _AlIctPageState();
}

class _AlIctPageState extends State<AlIctPage> {
  static const List<Color> _gradient = [Color(0xFF4DB6AC), Color(0xFF00796B)];
  static const IconData _icon = Icons.lan_rounded;
  static const String _title = 'AL ICT';

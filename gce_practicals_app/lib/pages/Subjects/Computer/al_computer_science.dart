...
class AlComputerSciencePage extends StatefulWidget {
  const AlComputerSciencePage({super.key});

  @override
  State<AlComputerSciencePage> createState() => _AlComputerSciencePageState();
}

class _AlComputerSciencePageState extends State<AlComputerSciencePage> {
  static const List<Color> _gradient = [Color(0xFF7986CB), Color(0xFF3949AB)];
  static const IconData _icon = Icons.developer_board_rounded;
  static const String _title = 'AL Computer Science';

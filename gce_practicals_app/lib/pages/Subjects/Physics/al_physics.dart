...
class AlPhysicsPage extends StatefulWidget {
  const AlPhysicsPage({super.key});

  @override
  State<AlPhysicsPage> createState() => _AlPhysicsPageState();
}

class _AlPhysicsPageState extends State<AlPhysicsPage> {
  static const List<Color> _gradient = [Color(0xFFFFB74D), Color(0xFFF57C00)];
  static const IconData _icon = Icons.bolt_rounded;
  static const String _title = 'AL Physics';
